...
public class Fashion {
    public void fashionMethod(ArrayList<Object> arrayListObject) throws SQLException {
        Scanner scannerObject=new Scanner(System.in);

        System.out.println(ProductConstnts.DesignDisplau);
        ProductMain.productDetailsExceution("Select productid,brand,productname,productprice,productquantinty,discountpercentage,warrenty,descreption,productdiscountedprice from productdatatable where producttype='3';");
